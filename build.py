...
<section class="section" style="padding-top:0;">
  <div class="container">
    ...
    <div class="bento">
      <div class="tile b-md tile-brand reveal"><h3>Technology Hardware Issues</h3><p>Covered</p></div>
      <div class="tile b-md reveal"><h3>Business Software Issues</h3><p>Covered</p></div>
      <div class="tile b-md tile-accent reveal"><h3>Risk and Compliance Support</h3><p>Covered</p></div>
      <div class="tile b-md reveal"><h3>Cyber Security Software</h3><p>Covered</p></div>
      <div class="tile b-md reveal"><h3>Networking Issues</h3><p>Covered</p></div>
      <div class="tile b-md tile-accent reveal"><h3>3rd Party Vendor Support</h3><p>Covered</p></div>
    </div>
  </div>
</section>
    ...
    <div class="timeline">
      <div class="timeline-item">
        ...
        <div class="timeline-body">
          <h3>Picking great partners</h3>
          <p>Since beginning operations in 2003, CodeBlue has earned partnerships with Microsoft, Cisco, Hewlett Packard, Dell, SonicWALL, Ruckus, Brocade, Ubiquiti, and other top-tier technology manufacturers — designations that require certified technical staff and ongoing performance to maintain.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2004</div>
        <div class="timeline-body">
          <h3>Becoming an Application Services Provider</h3>
          <p>CodeBlue became one of the first Application Service Providers (ASPs) in the region, delivering software over the Internet to healthcare and education clients — what we'd call Cloud computing today — and became a high-speed Internet provider to growing businesses years before broadband was widely available.</p>
        </div>
      </div>
      <div class="timeline-item">
        ...
        <div class="timeline-body">
          ...
          <p>CodeBlue was one of the first 25 companies in Virginia to earn Microsoft's newly created Small Business Specialist designation.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2006</div>
        <div class="timeline-body">
          <h3>Monument Avenue</h3>
          <p>CodeBlue moved to its home on historic Monument Avenue in Richmond, giving the team fast, central access to clients across Central Virginia.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2007</div>
        <div class="timeline-body">
          <h3>Cisco Select Partner</h3>
          <p>CodeBlue became one of the first 50 companies in the mid-Atlantic to earn Cisco's newly created Select Partner designation, awarded to companies that pass rigorous tests in marketing, selling, planning, and building solutions for business and government.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2012</div>
        <div class="timeline-body">
          <h3>#3 ranked: SMB 500 List</h3>
          <p>CodeBlue was ranked #3 on the SMB 500 list, produced by the SMB Alliance community, recognizing it as one of the fastest-growing SMB-focused IT providers in the country.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2013</div>
        <div class="timeline-body">
          <h3>CRN Next-Gen 250</h3>
          <p>CodeBlue was chosen for CRN Magazine's Next-Gen 250 awards, recognizing innovative, progressive IT providers — the same year CodeBlue marked 10 years in business.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2014</div>
        <div class="timeline-body">
          <h3>CodeBlue Cloud</h3>
          <p>CodeBlue launched CodeBlue Cloud, a private cloud built for public- and private-sector clients who want Cloud computing with their data kept within the region — server computing, virtual desktops, replicated storage, and VoIP, backed by an in-house data center.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2015</div>
        <div class="timeline-body">
          <h3>Small Business Hall of Fame</h3>
          <p>CodeBlue was inducted into the WKH Solutions Small Business Hall of Fame, recognizing the processes and systems that make it easy for clients to engage with us, from service to sales.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2016</div>
        <div class="timeline-body">
          <h3>State and Local Government IT</h3>
          <p>CodeBlue entered the State and Local Government and Education (SLED) market, extending our full line of products and services to localities, school systems, and universities.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2017</div>
        <div class="timeline-body">
          <h3>Warsaw & the Northern Neck</h3>
          <p>CodeBlue opened a second office in Warsaw, Virginia, expanding into the Northern Neck and Middle Peninsula and bringing on new public- and private-sector clients across the region.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2018</div>
        <div class="timeline-body">
          <h3>15 years in service</h3>
          <p>CodeBlue marked 15 years in business providing carefully designed, reliably implemented technology solutions for businesses across Virginia.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2019</div>
        <div class="timeline-body">
          <h3>16 years in service</h3>
          <p>CodeBlue Cloud took the title of largest private cloud in Richmond, giving clients even more room to grow phone systems, application servers, desktops, and firewalls.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2020</div>
        <div class="timeline-body">
          <h3>17 years in service</h3>
          <p>CodeBlue expanded into access control and premise security monitoring.</p>
        </div>
      </div>
      <div class="timeline-item">
        ...
        <div class="timeline-body">
          ...
          <p>CodeBlue moved into its own space in Mechanicsville, VA — 6,000 square feet built for technology support and services.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2023</div>
        <div class="timeline-body">
          <h3>20 years in service</h3>
          <p>CodeBlue celebrated 20 years of service to the mid-Atlantic, thanks to the staff and partners who made it possible.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2025</div>
        <div class="timeline-body">
          <h3>PeopleFirst Support launches</h3>
          <p>CodeBlue introduces PeopleFirst Support, a flat per-person IT plan covering every device, vendor, and cyber security tool a team member touches.</p>
        </div>
      </div>
      <div class="timeline-item">
        <div class="timeline-year">2026</div>
        <div class="timeline-body">
          <h3>New site, new storefront</h3>
          <p>CodeBlue redesigns codebluetechnology.com around Tailored Support Options, and begins planning a walk-in retail store for parts, service, and home care.</p>
        </div>
      </div>
      <div class="timeline-item is-future">
        <div class="timeline-year">2027</div>
        <div class="timeline-body">
          <h3>Looking ahead</h3>
          <p>CodeBlue keeps investing in Core Values Driven support for Central Virginia and the Northern Neck, from managed IT to walk-in service.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="section" style="padding-top:0;">
  <div class="container">
    <div class="split reveal">
      <div class="split-media">
        {photo_fill("images/founder-trey-hayden.jpg", "Trey Hayden, Founder and CEO of CodeBlue Technology")}
      </div>
      <div>
...
<section class="section" style="padding-top:0;">
  <div class="container">
    ...
    <div class="bento">
      <div class="tile b-md tile-brand reveal"><h3>Little League Sponsorships</h3><p>CodeBlue sponsors area Little League organizations across Central Virginia.</p></div>
      <div class="tile b-md tile-accent reveal"><h3>International Rotary</h3><p>CodeBlue is home to several active Rotarians in both Mechanicsville and Warsaw, VA.</p></div>
    </div>
  ...
  <div class="container">
    <div class="split reveal">
      ...
      <div class="card">
        ...
        <p>From Little League sponsorships to international Rotary work, CodeBlue gives back to the Central Virginia community we serve.</p>
